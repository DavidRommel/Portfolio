...
* For this project I wasn't interested in checking for multicollinearity between the independent predictor variables, so I removed that section.
   * I was mostly testing application of a multiple regression model to a Tableau dashboard, and wanted as many predictor variables as possible for illustrative purposes.  I was not overly concerned with model validity for this project.
